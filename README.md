...
1. 从 [`dist`](dist) 目录下载最新版
   [`douxianren-lsp-api102-v1.3.4.apk`](dist/douxianren-lsp-api102-v1.3.4.apk)。
2. 在手机上安装 APK。
...
```text
2FEA107164BE1AEB7C7203E5905B4395BCA594CFBEBE20633408B61242B6EBC5
```
...
- 视频地址依次从 `play_addr`、`play_addr_h264`、`play_addr_bytevc1` 中选择，
  不使用带水印的下载地址链。
- 广告标记不会单独触发视频条目跳过；图文、长文章及无视频条目仍按模型分类过滤。
