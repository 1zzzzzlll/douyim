...
- 暂停后在右侧操作栏顶部显示半透明下载按钮，点击即可将当前无水印视频保存到系统
  `Download` 目录。
- 识别广告、图文、长文章及其他非视频条目，并自动切换到下一条内容；视频广告也会自动跳过。
...
1. 从 [`dist`](dist) 目录下载最新版
   [`douxianren-lsp-api102-v1.3.6.apk`](dist/douxianren-lsp-api102-v1.3.6.apk)。
2. 在手机上安装 APK。
...
```text
04CD55DF31271C9A071C21034E8BA12E0DEEE321C9121F956F87E7A17050CFD7
```
